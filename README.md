...
2. RECORTE AUTOMÁTICO
   (Se aísla el field of view (FoV), eliminando el marco de informacion, no filtra el musculo o tejidos)
   |
   V
3. PRE-PROCESAMIENTO
...
Leer el documento markdown 🗺️[*Instalacion*](https://github.com/f-arias/SMA-testing/blob/94ee54158e50f15daba10e7e0cba728f84c22d76/sma_python/Instalacion%20y%20uso.md)
